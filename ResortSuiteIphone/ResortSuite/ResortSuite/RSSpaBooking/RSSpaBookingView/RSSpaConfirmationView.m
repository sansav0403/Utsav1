...
{
    NSLog(@"bookingTime %@     %@",bookingTime , [NSString stringWithFormat:@"%d",bookedService.serviceTime]);
...
-(void)createSpaBooking
{
	...
	NSString *bodyString = [NSString stringWithFormat: 
							...
							[[spaAvailibilities objectAtIndex:0] startTime],
