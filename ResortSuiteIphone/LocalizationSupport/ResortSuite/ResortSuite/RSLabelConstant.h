...
#define Hotel_Reservation           @"Reservation :"
#define Hotel_Arival_Date           @"Arival Date :"
#define Hotel_Departure_Date        @"Departure Date :"
#define Hotel_Total_Guest           @"Total Guest(s) :"
#define Hotel_Room_Number           @"Room Number :"

#define Spa_Location            @"Location :"
#define Spa_Service             @"Service :"
#define Spa_Time                @"Time :"
#define Spa_Performed_By        @"Performed By :"
#define Spa_Room                @"Room :"
#define Spa_Description         @"Description :"
#define Spa_Client_instruction  @"Client                   Instructions :"

#define Golf_Course             @"Course :"
#define Golf_Tee_Time           @"Tee-Time :"

#define Dining_Venue			@"Venue :"
#define Dining_Time             @"Time :"
#define Dining_detail           @"detail :"

#define Transportation_Departure_location		@"Departure Location :"
#define Transportation_Departure_Time           @"Departure Time :"
#define Transportation_Arrival_Location         @"Arrival Location :"
#define Transportation_Arrival_Time             @"Arrival Time :"
//group Table
#define GroupTableViewTitle                     @"Group Events"
//event description view
#define GroupEventDesc_viewTitle                @"Event Details"

#define GroupEventDesc_EventLbl                 @"Event"
#define GroupEventDesc_LocationLbl              @"Location"
#define GroupEventDesc_DateLbl                  @"Date"
#define GroupEventDesc_TimeLbl                  @"Time"
...
#define SpaAvailableTimes                     @"Available Times"
//
...
#define SpaBookingNoPref            @"No Pref."

#define SpaBookingStaffMale         @"Male"
#define SpaBookingStaffFemale       @"Female"
//Spa service table view
#define SpaServiceTable_HeaderTitle     @"Search result"

#define SpaServiceTableCol_ServiceLbl   @"Service"
#define SpaServiceTableCol_PriceLbl     @"Price"
#define SpaServiceTableCol_TimeLbl      @"Time (min)"
//Class service table view
#define ClassServiceTableCol_StartTimeLbl       @"Start Time"
#define ClassServiceTableCol_PriceLbl           @"Price"
#define ClassServiceTableCol_TimeLbl            @"Time (min)"
//Spa Service Desc View labels
#define SpaServiceDesc_TitleHeader          @"Service"

#define SpaServiceDesc_serviceLbl           @"Service :"
#define SpaServiceDesc_DescriptionLbl       @"Description :"
#define SpaServiceDesc_DurationLbl          @"Duration(min) :"
#define SpaServiceDesc_PriceLbl             @"Price :"
#define SpaServiceDesc_ClientInstructionLbl @"Client                   Instructions :"
//Class Service Desc View Labels
#define ClassServiceDesc_DescriptionLbl         @"Description :"
#define ClassServiceDesc_NoOfClassLbl           @"# of Classes :"
#define ClassServiceDesc_StartTimeLbl           @"Start Time :"
#define ClassServiceDesc_DurationLbl            @"Duration(min) :"
#define ClassServiceDesc_PriceLbl               @"Price :"
#define ClassServiceDesc_ClientInstructionLbl   @"Client                   Instructions :"
...
#define ClassConfirmationView_Service           @"Class/Activity :"
#define ClassConfirmationView_NoOfClass         @"# of Classes :"
#define ClassConfirmationView_StartTime         @"Start Time :"
#define ClassConfirmationView_Date              @"Date :"
#define ClassConfirmationView_Duration          @"Duration(min) :"
#define ClassConfirmationView_Price             @"Price :"
#define ClassConfirmationView_Description       @"Description :"
//Golf Booking Form
...
#define loginOption_screen_title            @"Sign In"
#define LOGOUT_SCREEN_TITLE                 @"Sign Out"
#define VERIFY_EMAIL_VIEW_TITLE             @"Verify Email"
...
#define alertMessageForUnmatchedPassword        @"Enter the same Password as above"
...
#pragma mark - MAPS
#define MapView_title           @"Map"
#define Map_infoBUtton_title    @"Info"
